...
- [ ] T018 Create Drizzle client with better-sqlite3 driver in src/main/database/client.ts
- [ ] T019 Create migration runner in src/main/database/migrate.ts
- [ ] T020 Create database module exports in src/main/database/index.ts
