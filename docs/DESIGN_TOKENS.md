...
| ------------------ | --------- | --------- | --------- | ------------------- | ------------------ |
| `--background`     | `#f6f5f0` | `#ffffff` | `#121212` | `bg-background`     | Page background    |
| `--foreground`     | `#1a1a1a` | `#37352f` | `#bcbab6` | `text-foreground`   | Primary text       |
| `--surface`        | `#efefe9` | `#f7f6f3` | `#202020` | `bg-surface`        | Panels, sidebar bg |
...
| `--primary-foreground`     | `#f6f5f0` | `#ffffff` | `#121212` | `text-primary-foreground`     |
| `--secondary`              | `#efefe9` | `#f7f6f3` | `#202020` | `bg-secondary`                |
| `--secondary-foreground`   | `#1a1a1a` | `#37352f` | `#bcbab6` | `text-secondary-foreground`   |
| `--muted`                  | `#efefe9` | `#f7f6f3` | `#202020` | `bg-muted`                    |
...
| `--popover`                | `#f6f5f0` | `#ffffff` | `#202020` | `bg-popover`                  |
| `--popover-foreground`     | `#1a1a1a` | `#37352f` | `#bcbab6` | `text-popover-foreground`     |
| `--card`                   | `#ffffff` | `#ffffff` | `#202020` | `bg-card`                     |
...
| `--card-grey`     | `#e0e0e0` | `#e3e2e0` | `#202020` | Unknown / Sort           |
...
| `checkboxSize`        | _(default)_                           | `h-3.5 w-3.5` (14px)                  |
