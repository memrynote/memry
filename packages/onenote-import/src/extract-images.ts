 ...
 *
 * Pure string transform: scans `<img src="data:image/...;base64,...">`,
 * replaces each data URI with a short placeholder ref, and returns the lifted
 * images. The desktop importer maps each placeholder → a saved attachment URL
 * after `createNote`.
 *
 * @module onenote-import/extract-images
 */
...
/** Map a MIME type (e.g. `image/png`) to a file extension (e.g. `png`). */
