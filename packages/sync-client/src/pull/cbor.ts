...
/**
 * Canonical CBOR encoding for signature payloads — the platform-free twin of
 * `apps/desktop/src/main/crypto/cbor.ts` (same rejection rule, same Map-based
 * ordering), kept byte-identical because every sync item signature in
 * production was produced against it.
 */
