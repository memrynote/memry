  ...
  test: {
    ...
    projects: [
      {
        ...
        test: {
          ...
          include: [
            ...
            '../../packages/csv-import/src/**/*.{test,spec}.{ts,tsx}',
            '../../packages/todoist-import/src/**/*.{test,spec}.{ts,tsx}',
            '../../packages/ticktick-import/src/**/*.{test,spec}.{ts,tsx}',
            ...
            '../../packages/roam-import/src/**/*.{test,spec}.{ts,tsx}',
            '../../packages/apple-journal-import/src/**/*.{test,spec}.{ts,tsx}',
            '../../packages/apple-notes-import/src/**/*.{test,spec}.{ts,tsx}',
            '../../packages/onenote-import/src/**/*.{test,spec}.{ts,tsx}',
    ...
    coverage: {
      ...
      include: [
        ...
        '../../packages/csv-import/src/**/*.ts',
        '../../packages/todoist-import/src/**/*.ts',
        '../../packages/ticktick-import/src/**/*.ts',
        ...
        '../../packages/roam-import/src/**/*.ts',
        '../../packages/apple-journal-import/src/**/*.ts',
        '../../packages/apple-notes-import/src/**/*.ts',
        '../../packages/onenote-import/src/**/*.ts',
