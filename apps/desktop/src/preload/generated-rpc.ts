  ...
  return {
    notes: {
      ...
      renameFolder: ((oldPath, newPath) =>
        invoke('notes:rename-folder', { oldPath, newPath })) as GeneratedRpcApi['notes']['renameFolder'],
      deleteFolder: ((path) =>
      ...
      getPropertyDefinitions: (() =>
        invoke('notes:get-property-definitions')) as GeneratedRpcApi['notes']['getPropertyDefinitions'],
      createPropertyDefinition: ((input) =>
        invoke('notes:create-property-definition', input)) as GeneratedRpcApi['notes']['createPropertyDefinition'],
      updatePropertyDefinition: ((input) =>
        invoke('notes:update-property-definition', input)) as GeneratedRpcApi['notes']['updatePropertyDefinition'],
      ensurePropertyDefinition: ((name, type) =>
        invoke('notes:ensure-property-definition', { name, type })) as GeneratedRpcApi['notes']['ensurePropertyDefinition'],
      addPropertyOption: ((propertyName, option) =>
        invoke('notes:add-property-option', { propertyName, option })) as GeneratedRpcApi['notes']['addPropertyOption'],
      addStatusOption: ((propertyName, categoryKey, option) =>
        invoke('notes:add-status-option', { propertyName, categoryKey, option })) as GeneratedRpcApi['notes']['addStatusOption'],
      removePropertyOption: ((propertyName, optionValue) =>
        invoke('notes:remove-property-option', { propertyName, optionValue })) as GeneratedRpcApi['notes']['removePropertyOption'],
      ...
      deletePropertyDefinition: ((name) =>
        invoke('notes:delete-property-definition', name)) as GeneratedRpcApi['notes']['deletePropertyDefinition'],
      ...
      deleteAttachment: ((noteId, filename) =>
        invoke('notes:delete-attachment', { noteId, filename })) as GeneratedRpcApi['notes']['deleteAttachment'],
      getFolderConfig: ((folderPath) =>
        invoke('notes:get-folder-config', folderPath)) as GeneratedRpcApi['notes']['getFolderConfig'],
      setFolderConfig: ((folderPath, config) =>
        invoke('notes:set-folder-config', { folderPath, config })) as GeneratedRpcApi['notes']['setFolderConfig'],
      getFolderTemplate: ((folderPath) =>
        invoke('notes:get-folder-template', folderPath)) as GeneratedRpcApi['notes']['getFolderTemplate'],
      exportPdf: ((input) =>
      ...
      importFiles: ((sourcePaths, targetFolder) =>
        invoke('notes:import-files', { sourcePaths, targetFolder })) as GeneratedRpcApi['notes']['importFiles'],
      showImportDialog: (() =>
        invoke('notes:show-import-dialog')) as GeneratedRpcApi['notes']['showImportDialog'],
      setLocalOnly: ((id, localOnly) =>
        invoke('notes:set-local-only', { id, localOnly })) as GeneratedRpcApi['notes']['setLocalOnly'],
      getLocalOnlyCount: (() =>
    ...
    tasks: {
      ...
      convertToSubtask: ((taskId, parentId) =>
        invoke('tasks:convert-to-subtask', { taskId, parentId })) as GeneratedRpcApi['tasks']['convertToSubtask'],
      ...
      reorderProjects: ((projectIds, positions) =>
        invoke('tasks:project-reorder', { projectIds, positions })) as GeneratedRpcApi['tasks']['reorderProjects'],
      createStatus: ((input) =>
        invoke('tasks:status-create', input)) as GeneratedRpcApi['tasks']['createStatus'],
      updateStatus: ((id, updates) =>
        invoke('tasks:status-update', { id, ...updates })) as GeneratedRpcApi['tasks']['updateStatus'],
      deleteStatus: ((id) =>
        invoke('tasks:status-delete', id)) as GeneratedRpcApi['tasks']['deleteStatus'],
      reorderStatuses: ((statusIds, positions) =>
        invoke('tasks:status-reorder', { statusIds, positions })) as GeneratedRpcApi['tasks']['reorderStatuses'],
      ...
      getUpcoming: ((days) =>
        invoke('tasks:get-upcoming', { days: days ?? 7 })) as GeneratedRpcApi['tasks']['getUpcoming'],
    ...
    inbox: {
      ...
      linkToNote: ((itemId, noteId, tags) =>
        invoke('inbox:link-to-note', itemId, noteId, tags ?? [])) as GeneratedRpcApi['inbox']['linkToNote'],
      addTag: ((itemId, tag) =>
      ...
      bulkTag: ((input) =>
        invoke('inbox:bulk-tag', input)) as GeneratedRpcApi['inbox']['bulkTag'],
      bulkSnooze: ((input) =>
      ...
      retryTranscription: ((itemId) =>
        invoke('inbox:retry-transcription', itemId)) as GeneratedRpcApi['inbox']['retryTranscription'],
      ...
      getFilingHistory: ((options) =>
        invoke('inbox:get-filing-history', options ?? {})) as GeneratedRpcApi['inbox']['getFilingHistory'],
    ...
    settings: {
      ...
      setJournalSettings: ((settings) =>
        invoke('settings:setJournalSettings', settings)) as GeneratedRpcApi['settings']['setJournalSettings'],
      getAISettings: (() =>
      ...
      getVoiceTranscriptionSettings: (() =>
        invoke('settings:getVoiceTranscriptionSettings')) as GeneratedRpcApi['settings']['getVoiceTranscriptionSettings'],
      setVoiceTranscriptionSettings: ((settings) =>
        invoke('settings:setVoiceTranscriptionSettings', settings)) as GeneratedRpcApi['settings']['setVoiceTranscriptionSettings'],
      getVoiceModelStatus: (() =>
        invoke('settings:getVoiceModelStatus')) as GeneratedRpcApi['settings']['getVoiceModelStatus'],
      downloadVoiceModel: (() =>
        invoke('settings:downloadVoiceModel')) as GeneratedRpcApi['settings']['downloadVoiceModel'],
      getVoiceRecordingReadiness: (() =>
        invoke('settings:getVoiceRecordingReadiness')) as GeneratedRpcApi['settings']['getVoiceRecordingReadiness'],
      getVoiceTranscriptionOpenAIKeyStatus: (() =>
        invoke('settings:getVoiceTranscriptionOpenAIKeyStatus')) as GeneratedRpcApi['settings']['getVoiceTranscriptionOpenAIKeyStatus'],
      ...
      setTabSettings: ((settings) =>
        invoke('settings:setTabSettings', settings)) as GeneratedRpcApi['settings']['setTabSettings'],
      getNoteEditorSettings: (() =>
        invoke('settings:getNoteEditorSettings')) as GeneratedRpcApi['settings']['getNoteEditorSettings'],
      setNoteEditorSettings: ((settings) =>
        invoke('settings:setNoteEditorSettings', settings)) as GeneratedRpcApi['settings']['setNoteEditorSettings'],
      getStartupThemeSync: (() => {
      ...
      setGeneralSettings: ((settings) =>
        invoke('settings:setGeneralSettings', settings)) as GeneratedRpcApi['settings']['setGeneralSettings'],
      getEditorSettings: (() =>
        invoke('settings:getEditorSettings')) as GeneratedRpcApi['settings']['getEditorSettings'],
      setEditorSettings: ((settings) =>
        invoke('settings:setEditorSettings', settings)) as GeneratedRpcApi['settings']['setEditorSettings'],
      getTaskSettings: (() =>
        invoke('settings:getTaskSettings')) as GeneratedRpcApi['settings']['getTaskSettings'],
      setTaskSettings: ((settings) =>
        invoke('settings:setTaskSettings', settings)) as GeneratedRpcApi['settings']['setTaskSettings'],
      getKeyboardSettings: (() =>
        invoke('settings:getKeyboardSettings')) as GeneratedRpcApi['settings']['getKeyboardSettings'],
      setKeyboardSettings: ((settings) =>
        invoke('settings:setKeyboardSettings', settings)) as GeneratedRpcApi['settings']['setKeyboardSettings'],
      resetKeyboardSettings: (() =>
        invoke('settings:resetKeyboardSettings')) as GeneratedRpcApi['settings']['resetKeyboardSettings'],
      getSyncSettings: (() =>
        invoke('settings:getSyncSettings')) as GeneratedRpcApi['settings']['getSyncSettings'],
      setSyncSettings: ((settings) =>
        invoke('settings:setSyncSettings', settings)) as GeneratedRpcApi['settings']['setSyncSettings'],
      getBackupSettings: (() =>
        invoke('settings:getBackupSettings')) as GeneratedRpcApi['settings']['getBackupSettings'],
      setBackupSettings: ((settings) =>
        invoke('settings:setBackupSettings', settings)) as GeneratedRpcApi['settings']['setBackupSettings'],
      getGraphSettings: (() =>
        invoke('settings:getGraphSettings')) as GeneratedRpcApi['settings']['getGraphSettings'],
      setGraphSettings: ((settings) =>
        invoke('settings:setGraphSettings', settings)) as GeneratedRpcApi['settings']['setGraphSettings'],
      registerGlobalCapture: (() =>
        invoke('settings:registerGlobalCapture')) as GeneratedRpcApi['settings']['registerGlobalCapture']
    },
    ...
    onInboxTranscriptionComplete: ((callback) =>
      subscribe('inbox:transcription-complete', callback)) as GeneratedRpcApi['onInboxTranscriptionComplete'],
    ...
    onVoiceModelProgress: ((callback) =>
      subscribe('settings:voiceModelProgress', callback)) as GeneratedRpcApi['onVoiceModelProgress'],
