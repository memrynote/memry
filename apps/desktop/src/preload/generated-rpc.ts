...
export function createGeneratedRpcApi({
  ...
  return {
    notes: {
      ...
      importFiles: ((sourcePaths, targetFolder, sourceType) => invoke("notes:import-files", { sourcePaths, targetFolder, sourceType })) as GeneratedRpcApi["notes"]["importFiles"],
      showImportDialog: ((sourceType) => invoke("notes:show-import-dialog", { sourceType })) as GeneratedRpcApi["notes"]["showImportDialog"],
