...
export function createGeneratedRpcApi({
  ...
  const api = {
    ...
    "settings": {
      ...
      "setSidebarNotesFirst": ((notesFirst) => invoke("settings:setSidebarNotesFirst", notesFirst)) as GeneratedRpcApi["settings"]["setSidebarNotesFirst"],
      "getSidebarShowFiles": (() => invoke("settings:getSidebarShowFiles")) as GeneratedRpcApi["settings"]["getSidebarShowFiles"],
      "setSidebarShowFiles": ((showFiles) => invoke("settings:setSidebarShowFiles", showFiles)) as GeneratedRpcApi["settings"]["setSidebarShowFiles"],
      ...
      "getTagSearches": (() => invoke("settings:getTagSearches")) as GeneratedRpcApi["settings"]["getTagSearches"],
    ...
    "calendar": {
      ...
      "discoverProviderCalendars": ((input) => invoke("calendar:discover-provider-calendars", input)) as GeneratedRpcApi["calendar"]["discoverProviderCalendars"],
      ...
      "openOsCalendarSettings": (() => invoke("calendar:open-os-calendar-settings")) as GeneratedRpcApi["calendar"]["openOsCalendarSettings"],
      ...
      "getExternalEvent": ((input) => invoke("calendar:get-external-event", input)) as GeneratedRpcApi["calendar"]["getExternalEvent"],
