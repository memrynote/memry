...
export function createGeneratedRpcApi({
  ...
  const api = {
    ...
    "settings": {
      ...
      "getCalendarProviderSettings": ((providerId) => invoke("settings:getCalendarProviderSettings", providerId)) as GeneratedRpcApi["settings"]["getCalendarProviderSettings"],
      "setCalendarProviderSettings": ((providerId, settings) => invoke("settings:setCalendarProviderSettings", providerId, settings)) as GeneratedRpcApi["settings"]["setCalendarProviderSettings"],
    ...
    "calendar": {
      ...
      "listProviderCalendars": ((options) => invoke("calendar:list-provider-calendars", options ?? { provider: 'google' })) as GeneratedRpcApi["calendar"]["listProviderCalendars"],
      ...
      "retryCalendarSourceSync": ((input) => invoke("calendar:retry-source-sync", input)) as GeneratedRpcApi["calendar"]["retryCalendarSourceSync"],
