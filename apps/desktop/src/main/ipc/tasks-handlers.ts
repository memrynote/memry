...
export function registerTasksHandlers(): void {
  ...
  ipcMain.handle(
    ...
    createValidatedHandler(TaskCreateSchema, withDb(async (db, input) => {
      const id = generateId()
  ...
  ipcMain.handle(
    ...
    createValidatedHandler(TaskUpdateSchema, withDb(async (db, input) => {
  ...
  ipcMain.handle(
    ...
    createStringHandler(withDb(async (db, id) => {
  ...
  ipcMain.handle(
    ...
    createValidatedHandler(TaskCompleteSchema, withDb(async (db, input) => {
  ...
  ipcMain.handle(
    ...
    createValidatedHandler(TaskMoveSchema, withDb(async (db, input) => {
  ...
  ipcMain.handle(
    ...
    createValidatedHandler(TaskReorderSchema, withDb(async (db, input) => {
  ...
  ipcMain.handle(
    ...
    createValidatedHandler(ConvertToSubtaskSchema, withDb(async (db, input) => {
  ...
  ipcMain.handle(
    ...
    createStringHandler(withDb(async (db, taskId) => {
  ...
  ipcMain.handle(
    ...
    createValidatedHandler(ProjectCreateSchema, withDb(async (db, input) => {
      const id = generateId()
  ...
  ipcMain.handle(
    ...
    createValidatedHandler(ProjectUpdateSchema, withDb(async (db, input) => {
  ...
  ipcMain.handle(
    ...
    createValidatedHandler(ProjectReorderSchema, withDb(async (db, input) => {
  ...
  ipcMain.handle(
    ...
    createValidatedHandler(StatusCreateSchema, withDb(async (db, input) => {
      const id = generateId()
  ...
  ipcMain.handle(
    ...
    createValidatedHandler(StatusUpdateSchema, withDb(async (db, input) => {
  ...
  ipcMain.handle(
    ...
    createValidatedHandler(StatusReorderSchema, withDb(async (db, input) => {
  ...
  ipcMain.handle(
    ...
    createValidatedHandler(BulkIdsSchema, withDb(async (db, input) => {
  ...
  ipcMain.handle(
    ...
    createValidatedHandler(BulkMoveSchema, withDb(async (db, input) => {
