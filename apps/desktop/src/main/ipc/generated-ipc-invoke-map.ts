...
export interface MainIpcInvokeHandlers {
  ...
  'saved-filters:update': (
    ...
    >
  >
  'search:add-recent': (...args: [string]) => Awaited<Promise<void>>
  'search:advanced': (
    ...args: [
      {
        ...
        operators?:
          ...
          | undefined
        titleOnly?: boolean | undefined
        sortBy?: 'title' | 'modified' | 'created' | 'relevance' | undefined
    ...
    >
  >
  'search:clear-recent': (...args: []) => Awaited<Promise<void>>
  'search:find-backlinks': (...args: [string]) => Awaited<
    Promise<
      {
        type: 'note'
        id: string
    ...
    >
  >
  'search:find-by-tag': (...args: [string]) => Awaited<
    Promise<
      {
        type: 'note'
        id: string
    ...
    >
  >
  'search:get-recent': (...args: []) => Awaited<Promise<string[]>>
  'search:get-stats': (
    ...args: []
  ) => Awaited<Promise<import('../../../../../packages/contracts/src/search-api').SearchStats>>
  'search:notes': (...args: [{ query: string; limit?: number | undefined }]) => Awaited<
    Promise<
      {
        type: 'note'
        id: string
  ...
  'search:query': (
    ...args: [
      {
        query: string
        types?: ('note' | 'task' | 'journal')[] | undefined
        tags?: string[] | undefined
        ...
        sortBy?: 'modified' | 'created' | 'relevance' | undefined
        limit?: number | undefined
        offset?: number | undefined
      }
    ]
    ...
    Promise<
      | import('../../../../../packages/contracts/src/search-api').SearchResponse
      | { results: never[]; total: number; hasMore: boolean; queryTime: number; error: string }
    >
  >
  'search:quick': (
  ...
  >
  'search:rebuild-index': (...args: []) => Awaited<Promise<void>>
  'search:suggestions': (
    ...args: [{ prefix: string; limit?: number | undefined }]
  ) => Awaited<
    Promise<import('../../../../../packages/contracts/src/search-api').SuggestionsResponse>
  >
