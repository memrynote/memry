...
export interface MainIpcInvokeHandlers {
  ...
  >
  'search:add-recent': (
    ...args: [{ query: string; resultCount: number }]
  ) => Awaited<Promise<import('../../../../../packages/contracts/src/search-api').RecentSearch>>
  'search:clear-recent': (...args: []) => Awaited<Promise<{ cleared: true }>>
