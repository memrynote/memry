...
export interface MainIpcInvokeHandlers {
  ...
  'notes:add-status-option': (
    ...args: [
      { propertyName: string; categoryKey: string; option: { value: string; color: string } }
    ]
  ) => Awaited<Promise<{ success: boolean }>>
  'notes:create': (
    ...args: [
  ...
  'notes:delete-version': (
    ...
    Promise<{ success: boolean; error?: undefined } | { success: boolean; error: string }>
  >
  'notes:ensure-property-definition': (...args: [{ name: string; type: string }]) => Awaited<
    Promise<
      | {
          success: boolean
          definition:
  ...
  ) => Awaited<Promise<{ success: boolean; path?: string | undefined; error?: string | undefined }>>
  'notes:export-pdf': (
    ...args: [
      {
        noteId: string
