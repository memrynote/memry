          ...
          >
            ...
            <DropdownMenuItem className="rounded-md cursor-pointer hover:bg-gray-100 focus:bg-gray-100 transition-colors">
              ...
              <span className="text-gray-600">
                {tPhaseF('phaseF.componentsTeamSwitcher.newWorkspace')}
              </span>
            </DropdownMenuItem>
            ...
            >
              ...
              <span className="flex-1 text-gray-900">
                {tPhaseF('phaseF.componentsTeamSwitcher.darkMode')}
              </span>
              <Switch
                checked={isDarkMode}
            ...
            <DropdownMenuItem className="rounded-md cursor-pointer hover:bg-gray-100 focus:bg-gray-100 transition-colors">
              ...
              <span className="text-gray-900">
                {tPhaseF('phaseF.componentsTeamSwitcher.settings')}
              </span>
            </DropdownMenuItem>
            ...
            <DropdownMenuItem className="rounded-md cursor-pointer hover:bg-gray-100 focus:bg-gray-100 transition-colors">
              ...
              <span className="text-gray-900">
                {tPhaseF('phaseF.componentsTeamSwitcher.integrations')}
              </span>
            </DropdownMenuItem>
            ...
            <DropdownMenuItem className="rounded-md cursor-pointer hover:bg-red-50 focus:bg-red-50 transition-colors">
              ...
              <span className="text-red-500 font-medium">
                {tPhaseF('phaseF.componentsTeamSwitcher.signOut')}
              </span>
            </DropdownMenuItem>
            ...
            <DropdownMenuItem className="rounded-md cursor-pointer hover:bg-gray-100 focus:bg-gray-100 transition-colors">
              ...
              <span className="text-gray-600">
                {tPhaseF('phaseF.componentsTeamSwitcher.downloadOnIos')}
              </span>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
