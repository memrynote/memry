        ...
        <DropdownMenu>
          ...
          >
            ...
            <DropdownMenuItem className="rounded-md cursor-pointer hover:bg-gray-100 focus:bg-gray-100 transition-colors">
              ...
              <span className="text-gray-600">{/* TODO(i18n): wrap in t() */}New workspace</span>
            </DropdownMenuItem>
            ...
            >
              ...
              <span className="flex-1 text-gray-900">{/* TODO(i18n): wrap in t() */}Dark mode</span>
              <Switch
                checked={isDarkMode}
            ...
            <DropdownMenuItem className="rounded-md cursor-pointer hover:bg-gray-100 focus:bg-gray-100 transition-colors">
              ...
              <span className="text-gray-900">{/* TODO(i18n): wrap in t() */}Settings</span>
            </DropdownMenuItem>
            ...
            <DropdownMenuItem className="rounded-md cursor-pointer hover:bg-gray-100 focus:bg-gray-100 transition-colors">
              ...
              <span className="text-gray-900">{/* TODO(i18n): wrap in t() */}Integrations</span>
            </DropdownMenuItem>
            ...
            <DropdownMenuItem className="rounded-md cursor-pointer hover:bg-gray-100 focus:bg-gray-100 transition-colors">
              ...
              <span className="text-gray-600">{/* TODO(i18n): wrap in t() */}Download on iOS</span>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </SidebarMenuItem>
