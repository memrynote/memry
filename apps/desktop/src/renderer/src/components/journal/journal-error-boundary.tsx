            ...
            >
              <div className="flex flex-col items-center gap-4 text-center max-w-md">
                ...
                <p className="text-sm text-muted-foreground">
                  {this.props.date
                    ? t('error.description', { date: this.props.date })
                    : t('error.descriptionNoDate')}
                </p>
                ...
                {this.props.pendingContent && (
                  <div className="w-full p-3 bg-amber-50 dark:bg-amber-900/20 rounded-md border border-amber-200 dark:border-amber-800/50">
                    <p className="text-xs text-amber-700 dark:text-amber-400 mb-2">
                      {t('error.unsavedContent', { length: this.props.pendingContent.length })}
                    </p>
                    <Button
                      ...
                      aria-label={t('action.copyUnsavedContent')}
                    >
                      {t('action.copyUnsavedContent')}
                    </Button>
                  </div>
                )}
