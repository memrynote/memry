...
function MemryMark({ className }: { className?: string }): React.JSX.Element {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M637.44 648L1.28 304.64C5.207 223.285 40.015 146.493 98.597 89.907C157.18 33.32 235.144 1.204 316.571 0.104C398.013 -1 476.811 28.995 536.904 83.973C596.997 138.952 633.863 214.776 639.992 296C646.154 215.041 682.856 139.453 742.669 84.547C802.481 29.64 880.936 -0.48 962.123 0.296C1043.31 1.067 1121.18 32.676 1179.92 88.712C1238.68 144.748 1273.94 221.024 1278.56 302.085L637.44 648Z" />
      <path d="M0 650.239V1031.04H1280V650.239H0Z" />
    </svg>
  )
}
