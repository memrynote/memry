...
interface AddEventToProjectDialogProps {
  open: boolean
...
/**
 * Calendar item chip context menu → "Add to project": lists active projects
 * and links the event to the chosen one via `PROJECT_LINK_ITEM`.
 */
export const AddEventToProjectDialog = ({
  open,
  onOpenChange,
  eventId
}: AddEventToProjectDialogProps): React.JSX.Element => {
  const { t } = useT('tasks')
...
export default AddEventToProjectDialog
