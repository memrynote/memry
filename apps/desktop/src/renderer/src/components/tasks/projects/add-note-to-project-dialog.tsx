...
interface AddNoteToProjectDialogProps {
  open: boolean
...
/**
 * Note ⋯ menu → "Add to project": lists active projects and links the note
 * to the chosen one via `PROJECT_LINK_ITEM`.
 */
export const AddNoteToProjectDialog = ({
  open,
  onOpenChange,
  noteId
}: AddNoteToProjectDialogProps): React.JSX.Element => {
  const { t } = useT('tasks')
...
export default AddNoteToProjectDialog
