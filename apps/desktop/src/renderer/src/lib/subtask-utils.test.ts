  ...
  describe('T092: Progress Calculation', () => {
    ...
    describe('buildTaskTree', () => {
      ...
      it('maintains subtask order from subtaskIds', () => {
        ...
        expect(result[0].subtasks.map((s) => s.id)).toEqual(['sub-3', 'sub-1', 'sub-2'])
      })
  ...
  describe('T093: Validation & Constraints', () => {
    ...
    describe('validateSubtaskRelationship', () => {
      ...
      it('returns error "Parent or subtask not found" when parent missing', () => {
        ...
        const result = validateSubtaskRelationship('nonexistent', 'subtask-1', [subtask])
      ...
      it('returns error "Parent or subtask not found" when subtask missing', () => {
        const parent = createMockTask({ id: 'parent-1' })
        const result = validateSubtaskRelationship('parent-1', 'nonexistent', [parent])
      ...
      it('returns error "Subtask must belong to the same project as parent"', () => {
        ...
        const result = validateSubtaskRelationship('parent-1', 'subtask-1', [parent, subtask])
  ...
  describe('T094: Filtering & Sorting', () => {
    describe('filterTasksWithSubtasks', () => {
      ...
      it('includes subtasks of matching parents', () => {
        ...
        const result = filterTasksWithSubtasks([parent, subtask], (t) => t.priority === 'high')
      ...
      it('filters by due date', () => {
        ...
        const result = filterTasksWithSubtasks([parent, subtask, noDate], (t) => t.dueDate !== null)
      ...
      it('returns empty when no matches', () => {
        ...
        const result = filterTasksWithSubtasks([task], (t) => t.priority === 'urgent')
    ...
    describe('sortTasksWithSubtasks', () => {
      ...
      it('keeps subtasks immediately after their parent', () => {
        ...
        const result = sortTasksWithSubtasks([parent1, sub1, sub2, parent2], (a, b) =>
          a.title.localeCompare(b.title)
        )
      ...
      it('preserves subtask order from subtaskIds', () => {
        ...
        const result = sortTasksWithSubtasks([parent, sub1, sub2, sub3], () => 0)
  ...
  describe('T095: CRUD Operations', () => {
    describe('createSubtask', () => {
      it('returns success with updatedTasks and newTask', () => {
        ...
        const result = createSubtask({ title: 'New Subtask', parentId: 'parent-1' }, [parent])
        ...
        expect(result.updatedTasks?.find((t) => t.id === 'parent-1')?.subtaskIds).toContain(
          result.newTask?.id
        )
      })

      it('returns error "Parent task not found"', () => {
        const result = createSubtask({ title: 'New Subtask', parentId: 'nonexistent' }, [])
    ...
    describe('createMultipleSubtasks', () => {
      it('creates all subtasks with newTasks array', () => {
        ...
        const result = createMultipleSubtasks('parent-1', ['Task A', 'Task B', 'Task C'], [parent])

        expect(result.success).toBe(true)
        expect(result.newTasks).toHaveLength(3)
        expect(result.newTasks?.map((t) => t.title)).toEqual(['Task A', 'Task B', 'Task C'])
      })
      ...
      it('adds all new subtask IDs to parent', () => {
        ...
        const result = createMultipleSubtasks('parent-1', ['Task A', 'Task B'], [parent])

        const updatedParent = result.updatedTasks?.find((t) => t.id === 'parent-1')
    ...
    describe('deleteParentWithSubtasks', () => {
      it('promotes all subtasks when keepSubtasks=true', () => {
        ...
        const result = deleteParentWithSubtasks('parent-1', true, [parent, sub1, sub2])

        expect(result.success).toBe(true)
        expect(result.updatedTasks?.find((t) => t.id === 'parent-1')).toBeUndefined()
      ...
      it('deletes all subtasks when keepSubtasks=false', () => {
        ...
        const result = deleteParentWithSubtasks('parent-1', false, [parent, sub1, sub2, otherTask])
      ...
      it('handles parent with no subtasks', () => {
        ...
        const result = deleteParentWithSubtasks('parent-1', false, [parent, otherTask])
  ...
  describe('T096: Reordering', () => {
    describe('reorderSubtasks', () => {
      ...
      it('returns reorderedTasks', () => {
        ...
        const result = reorderSubtasks('parent-1', ['sub-2', 'sub-1'], [parent, sub1, sub2])

        expect(result.reorderedTasks).toBeDefined()
        expect(result.reorderedTasks?.map((t) => t.id)).toEqual(['sub-2', 'sub-1'])
      })
      ...
      it('returns error "Invalid subtask IDs in new order"', () => {
        ...
        const result = reorderSubtasks('parent-1', ['sub-1', 'invalid-id'], [parent])
      ...
      it('appends missing IDs to end', () => {
        ...
        const result = reorderSubtasks('parent-1', ['sub-2', 'sub-1'], [parent, sub1, sub2, sub3])
  ...
  describe('T097: Promote & Demote', () => {
    ...
    describe('demoteToSubtask', () => {
      ...
      it('fails when parent is a subtask (no nested)', () => {
        ...
        const result = demoteToSubtask('task-1', 'parent-1', [grandparent, parent, task])
  ...
  describe('T098: Completion Handling', () => {
    describe('completeParentWithSubtasks', () => {
      it('marks all subtasks completed when completeSubtasks=true', () => {
        ...
        const result = completeParentWithSubtasks('parent-1', true, [parent, sub1, sub2])
      ...
      it('only marks parent completed when completeSubtasks=false', () => {
        ...
        const result = completeParentWithSubtasks('parent-1', false, [parent, sub1])
      ...
      it('does not re-complete already completed subtasks', () => {
        ...
        const result = completeParentWithSubtasks('parent-1', true, [parent, sub1])
