...
use memry_desktop_tauri_lib::crypto::sign_verify::{
    device_id_from_public_key, generate_keypair, keypair_from_seed, sign_detached,
    verify_detached, DEVICE_ID_HASH_LENGTH, PUBLIC_KEY_LENGTH, SECRET_KEY_LENGTH, SEED_LENGTH,
    SIGNATURE_LENGTH,
};
...
fn keypair_from_seed_matches_rfc8032_test_1_empty_message() {
    ...
    let expected_public = hex_decode(
