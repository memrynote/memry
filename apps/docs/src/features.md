...
The desktop app ships a `memry` CLI that can be enabled from Settings with a selected default vault. It can initialize and open a vault, create and update notes, manage note attachments and exports, write journal entries, manage tasks/projects, capture inbox items, and search from scripts or a terminal.
